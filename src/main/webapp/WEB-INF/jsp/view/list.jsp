...
<html>
    ...
    <body class="d-flex flex-column h-100 vsc-initialized">
        ...
        <div class="container-fluid p-3">
            <h1 class="display-1 " style="text-shadow: 2px 2px #8f8282;">Welcome to COMP S380F!</h1>
        </div>
        <div class="container-fluid p-3 ">
            <div class="row">
                ...
                <div class="col-8 list-group ">
                    <c:choose>
                        <c:when test="${fn:length(lectureDatabase) == 0}">
                            <p class="h2">There are no lectures in the system.</p>
                        </c:when>
                        <c:otherwise>
                            <p class="h2">Here're the study resources of the course</p>
