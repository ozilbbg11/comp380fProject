    ...
    <body>
        <div class="wrapper">
            ...
            <c:if test="${param.logout != null}">
               ...
               <h1 class="text-center  mt-4 name">Login to the system <spring:message code="loginPage.title" text="Default text"/> </h1>
            <form class="p-3 mt-3" action="cslogin" method="POST">
                ...
                <a class="btn mt-3" href="<c:url value="/registration?"/><%=request.getQueryString()%>" />Sign up</a>
        </div>
    </body>
</html>
